                ...
                <div class="row">
                        ...
                        <div class="card col-md-3">
                            ...
                            <br>
                                ...
                                <p class="card-text">{{ $app->Genres }}</p>
                                <p class="card-text">{{ $app->Type }}</p>
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                                <div class="btn-group mx-auto" role="group" aria-label="First group">
                                    ...
                                    @for ($i = 1; $i <= ceil($appCount/600); $i++)
                                    <a href="/apps?pg={{$i}}" class="btn btn-secondary {{ $cpage == $i ? 'disabled' : ''}}">{{$i}}</a>
                                    @endfor
                                    <a href="/apps?pg={{ $cpage + 1}}" class="btn btn-secondary {{$cpage == ceil($appCount/600) ? 'disabled' : '' }}">&gt</a>
                                </div>
                          </div>
                     </div>
                 </div>
